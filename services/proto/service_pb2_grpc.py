...
class NLToSQLServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.QueryDB = channel.unary_unary(
                '/servicepb.NLToSQLService/QueryDB',
...
class NLToSQLServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_NLToSQLServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'servicepb.NLToSQLService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('servicepb.NLToSQLService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class NLToSQLService(object):
    """Missing associated documentation comment in .proto file."""
